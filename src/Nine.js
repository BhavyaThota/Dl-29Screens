...
const Nine = () => {
    return (
        ...
        <img src="./assets/images/dl1.png" class="w-72 ml-96 mt-10 relative left-20"></img>
        <img src="./assets/images/girl1.png" class="ml-40 relative bottom-36"></img></div>
        ...
        <p class="ml-96 text-gray-300 text-base relative bottom-4">PRICE</p>
            ...
            <div>
                <img src="./assets/images/aws.jpg" class="w-40 ml-20"></img>
