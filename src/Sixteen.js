    ...
    return (
        ...
        <div>
           ...
           <div>
               ...
               <button class="text-white text-xs w-52 p-4 rounded-tr-3xl bg-yellow-500  rounded-l-3xl relative bottom-24 left-1" style={{marginLeft:904}}>Have a doubt?Rise a query</button>
               <img src="./assets/images/greendot.png" class="w-2 relative bottom-32 left-52" style={{marginLeft:900}}></img>
           </div>
    </div>
        </div>
    )
