...
const Second = () => {
    return (
        ...
        <div >
            <img src="./assets/images/girl2.png" style={{width:950}} class="ml-48 relative top-12"></img>
    </div>
        <div class="ml-96 relative left-28 bottom-96 " style={{position:"relative",bottom:650}}>
            <img src="./assets/images/dl1.png" class="w-72"></img>
        </div>
        <div class="border border-gray-300 border-solid bg-white ml-96 relative left-8 drop-shadow-2xl" style={{width:470,height:420,position:"relative",bottom:600}}>
            ...
            <button class="border-2 ml-44 text-white w-32 bg-blue-500 rounded-3xl p-1">sign up</button>
            <p class="ml-56 text-gray-300 mt-2">OR</p>
            <div class="mt-2">
            <img src="./assets/images/linkdn.png" class="w-10 ml-48"></img>
            <img src="./assets/images/google.png" class="w-8 relative left-60 bottom-8 ml-2 "></img>
            </div>
