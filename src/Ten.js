    ...
    return (
        ...
        <div>
           ...
           <div>
               ...
               <AiFillStar class="relative ml-28 " color="gray" style={{fontSize:30,position:"relative",bottom:29}}/>
               <AiFillStar class="relative ml-36 " color="gray" style={{fontSize:30,position:"relative",bottom:59}}/>
               <AiFillStar class="relative ml-44 " color="gray" style={{fontSize:30,position:"relative",bottom:89}}/>
               <AiFillStar class="relative ml-52 " color="gray" style={{fontSize:30,position:"relative",bottom:119}}/>
           ...
           <button class="text-white text-xs w-52 p-4 rounded-tr-3xl bg-yellow-500 rounded-l-3xl relative bottom-20" style={{marginLeft:904}}>Have a doubt?Rise a query</button>
               <img src="./assets/images/greendot.png" class="w-2 relative bottom-28" style={{marginLeft:900}}></img>
    </div>
        </div>
    )
}
